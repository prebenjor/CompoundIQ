...
const translations: Record<Lang, Translations> = {
  no: {
    ...
    'nav-pricing': 'Priser',
    'nav-login': 'Logg inn',
    'nav-get-started': 'Bli med pa ventelisten',
    'hero-badge': 'Norske skatteregler innebygd',
    'hero-title-line1': 'Se hva pengene dine',
    'hero-title-line2': 'faktisk vokser til',
    'hero-subtitle':
      'CompoundIQ hjelper deg a modellere investeringsvekst med norske skatteregler, ASK, BSU og inflasjon i samme verktoy.',
    'hero-cta-primary': 'Prov kalkulatoren',
    ...
    'features-title': 'Forsta norsk sparing og investering',
    'features-subtitle':
      'Kalkulatorer og scenarioverktoy tilpasset norske skatteregler - uten finansiell radgivning.',
    'feat-nordnet-title': 'Renterente-kalkulator',
    'feat-nordnet-desc':
      'Juster startbelop, sparing, avkastning og tidshorisont, og se effekten umiddelbart.',
    'feat-nordnet-tag': 'Gratis a bruke',
    'feat-oslobors-title': 'Skatteeffekt',
    'feat-oslobors-desc':
      'Se hvordan skatt, inflasjon og tid pa markedet pavirker den reelle avkastningen.',
    'feat-ask-title': 'ASK og BSU-planlegging',
    'feat-ask-desc':
      'Sammenlign ASK, BSU og skattepliktig sparing med en modell som er enkel a justere.',
    'feat-news-title': 'Kontosammenligning',
    'feat-news-desc':
      'Sammenlign ulike kontotyper side ved side og se hvilket oppsett som passer deg best.',
    'feat-calc-title': 'Scenarioverktoy',
    'feat-calc-desc':
    ...
    'calc-subtitle':
      'Bruk kalkulatoren til a projisere investeringsvekst med norske standardforutsetninger.',
    'calc-account-label': 'Kontotype',
    'calc-account-ask': 'ASK',
    'calc-account-vanlig': 'Fond/aksjer',
    'calc-account-bank': 'Bankkonto',
    'calc-tax-note-ask': '37,84 % skatt pa gevinst ved uttak.',
    'calc-tax-note-vanlig': '37,84 % effektiv skatt pa avkastning i forenklet modell.',
    'calc-tax-note-bank': '22 % skatt pa renteinntekter.',
    'calc-principal-label': 'Startinvestering',
    'calc-monthly-label': 'Manedlig sparing',
    'calc-rate-label': 'Forventet arsavkastning',
    'calc-years-label': 'Tidshorisont',
    'calc-inflation-label': 'Forventet inflasjon',
    'calc-contrib-growth-label': 'Arlig okning i sparing',
    ...
    'calc-withdrawal-label': 'Berekraftig uttak (4 %)',
    'calc-per-month': '/mnd',
    'calc-legend-balance': 'Saldo',
    'calc-legend-real': 'Realverdi',
    'calc-legend-contrib': 'Innskudd',
    'calc-show-table': 'Vis arsfordeling',
    'calc-hide-table': 'Skjul arsfordeling',
    'calc-table-year': 'Ar',
    ...
    'how-title': 'Kom i gang pa 3 steg',
    ...
    'step-2-desc': 'Fyll inn sparing, tid og avkastning, eller legg inn portfolio manuelt.',
    ...
    'pricing-subtitle': 'Start gratis. Oppgrader nar du trenger mer.',
    'plan-free-name': 'Gratis',
    'plan-free-price': '0',
    'plan-free-period': '/mnd',
    'plan-free-desc': 'Kalkulator og manuell portfolio',
    'plan-free-f1': 'Kalkulator for ASK, fond/aksjer og bankkonto',
    'plan-free-f2': 'Skattejustert beregning',
    'plan-free-f3': 'Inflasjon hentet fra SSB',
    'plan-free-f4': 'Realverdi, multiplikator og uttak',
    'plan-free-f5': 'Arsfordeling og graf',
    'plan-free-f6': 'Ingen kredittkort nodvendig',
    'plan-free-cta': 'Bli med pa ventelisten',
    'plan-pro-name': 'Pro',
    'plan-pro-badge': 'Kommer snart',
    'plan-pro-price': '49',
    'plan-pro-period': '/mnd',
    'plan-pro-desc': 'Lagre, sammenlign og eksporter',
    'plan-pro-f1': 'Alt i Gratis',
    'plan-pro-f2': 'Synk mellom enheter',
    'plan-pro-f3': 'Sammenligning side ved side',
    'plan-pro-f4': 'Flere planleggingsverktoy',
    'plan-pro-f5': 'Del scenario med lenke',
    'plan-pro-f6': 'Eksport til PDF og CSV',
    'plan-pro-cta': 'Bli med pa ventelisten',
    'cta-title': 'Forsta hva pengene dine faktisk vokser til',
    'cta-desc': 'Vaer blant de forste som prover CompoundIQ.',
    'cta-btn': 'Bli med pa ventelisten',
    'waitlist-placeholder': 'Din e-postadresse',
    'waitlist-btn': 'Bli med',
    'waitlist-loading': 'Sender...',
    'waitlist-success': 'Takk! Du er pa listen.',
    'waitlist-duplicate': 'Du er allerede pa listen.',
    'waitlist-error': 'Noe gikk galt. Prov igjen.',
    'waitlist-consent':
      'Ved a melde deg pa godtar du at vi lagrer e-postadressen din for a varsle deg om lanseringen. Se var <a href="/personvern">personvernerklaring</a>.',
    'footer-desc':
      'Kalkulatorer og scenarioverktoy for norske investorer, med ASK, BSU og skatteregler innebygd.',
    'footer-disclaimer':
      'CompoundIQ tilbyr ikke finansiell radgivning. Alt innhold er kun ment som informasjon.',
    ...
    'cookie-desc':
      'Vi bruker localStorage for a huske sprakvalg og samtykke. Ingen sporingskapsler er aktivert na.',
    'cookie-policy-link': 'Les mer',
    'cookie-necessary': 'Kun nodvendige',
  ...
  en: {
    ...
    'plan-pro-price': '49',
    'plan-pro-period': '/mo',
    'plan-pro-desc': 'Save, compare and export',
    'plan-pro-f1': 'Everything in Free',
    'plan-pro-f2': 'Sync across devices',
    'plan-pro-f3': 'Side-by-side comparisons',
    'plan-pro-f4': 'More planning tools',
    'plan-pro-f5': 'Shareable scenario links',
    'plan-pro-f6': 'PDF and CSV exports',
