...
const translations: Record<Lang, Translations> = {
  no: {
    ...
    'plan-pro-f4': 'Broker-import og automatisk oppdatering av beholdninger',
    ...
    'plan-pro-f8': 'Prioritert tilgang til nye integrasjoner og analyser',
  ...
  en: {
    ...
    'plan-pro-f4': 'Broker imports and automatic holding updates',
    ...
    'plan-pro-f8': 'Priority access to new integrations and analysis features',
